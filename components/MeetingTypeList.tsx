...
const MeetingTypeList = () => {
    ...
    const createMeeting = async() => {
        ...
        try{
          if(!values.dateTime){
            toast({ title: "Please select a date an a time"})
            return;
          } 
  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        {!callDetails ? (
          ...
          >
            <div className="flex flex-col gap-2.5">
              <label className="text-base text-normal leadig-[22px] text-sky-2">
                Add a description toption</label>
        ...
        <MeetingModel 
          ...
          className="text-center"
          buttonText="Start Meeting"
          handClick={()  => router.push(values.link)}
        >
